    ...
    <section id="about" className="py-20 px-6">
      <div className="max-w-2xl">
        ...
        <div className="space-y-6 text-lg leading-relaxed">
          ...
          <p>
            I fell in love with tech in high school, and as I moved through
            college, I found myself more and more conflicted in a field that
            sometimes felt like it was too far removed from the world I knew.
            Each item below is an attempt for me to bring a little bit of my
