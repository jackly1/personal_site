...
export default function SiteHeader() {
  ...
  return (
    <header className="relative z-10 flex h-24 shrink-0 items-center bg-[#fafafa] px-4 md:px-8">
      ...
      <div className="flex min-w-0 flex-1 items-center justify-start gap-2 pl-2 sm:pl-3 md:pl-4">
        ...
        <a
          ...
          className="ml-auto text-neutral-500 transition-colors hover:text-neutral-900"
          title="LinkedIn"
          aria-label="LinkedIn"
        >
