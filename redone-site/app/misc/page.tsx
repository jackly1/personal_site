...
export default function MiscPage() {
  return (
    <main className="flex min-h-0 flex-1 flex-col overflow-hidden">
      <div className="flex min-h-0 flex-1 flex-col px-6 pb-20 pt-10 md:px-12 md:pt-24">
        <div className="mx-auto flex w-full max-w-5xl min-h-0 flex-1 flex-col">
          ...
          <div className="flex min-h-0 flex-1 flex-col justify-center gap-6 pb-6 md:flex-row md:items-start md:gap-8 lg:gap-10">
