          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="space-y-6 leading-relaxed text-neutral-600">
              <p>
                ...
                about tech that genuinely helps people. I love film, a good
                book, biking, composting, and tech that genuinely helps people
              </p>

              <p>
                From New York, NY (currently at school in Ann Arbor, MI), I
                grew up surrounded by art. As a kid, I was always being dragged
                from one art gallery to the next. By adolescence, film became my
                medium of choice, I found a love for it that I had never found
                in anything before.
              </p>
            </div>
